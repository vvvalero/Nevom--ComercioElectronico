...
try {
    ...
    // 3. Crear un pedido por cada compra
    foreach ($compraIds as $index => $compraId) {
        ...
        $stmtPedido = $conexion->prepare("INSERT INTO pedido (precioTotal, cantidadTotal, formaPago, idCompra, idCliente) VALUES (?, ?, ?, ?, ?)");
        $stmtPedido->bind_param('disii', $precioParcial, $producto['cantidad'], $formaPago, $compraId, $clienteId);
